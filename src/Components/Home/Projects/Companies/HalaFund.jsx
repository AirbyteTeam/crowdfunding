                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-around mt-4">
                                        <div className="flex flex-col items-center my-1 sm:my-0">
                                            ...
                                            <span
                                                className="mt-1 text-black font-bold">{EnglishToPersian(project.remainingTime)}</span>
                                        </div>
                                        <div className="flex flex-col items-center my-1 sm:my-0">
                                            <BsCash fontSize="1.9rem" color="#4eb801"/>
                                            <span className="mt-1 text-neutral-700"> مبلغ مورد نياز</span>
                                            <span
                                                className="mt-1 text-black font-bold">{EnglishToPersian(project.totalPrice)}<span
                                        ...
                                        <div className="flex flex-col items-center my-1 sm:my-0">
                                            ...
                                            <span
                                                className="mt-1 text-black font-bold">{EnglishToPersian(SeparateNumber(project.peopleDonate.toString()))}<span
                                                className="mx-1">ریال</span></span>
                                        </div>
                                    </div>
                                    <div className="mt-4">
                                    ...
                                    <div className="mt-4 d-flex justify-content-center">
                                        <a href={`https://halalfund.ir/projectDetail/${project.code}`}
